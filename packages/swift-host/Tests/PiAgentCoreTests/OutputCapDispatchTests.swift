...
final class OutputCapDispatchTests: XCTestCase {
    ...
    func testTheCapIsClippedToTheRoomTheWindowLeavesAndTheReserveNeverStopsATurn() async throws {
        ...
        XCTAssertEqual(context["requestMethod"].text, "request-utf8-bytes", "no reply has measured this request yet")
        XCTAssertEqual(cap, 6_000 - sized - 60, "the ceiling is clipped to what the window still holds")
